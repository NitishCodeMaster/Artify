...
const mentors = [
    {
        ...
        rating: "4.9",
        image: teacher1,
        // --- DENIM BLUE THEME (Cool & Professional) ---
    ...
    },
    {
        ...
        rating: "5.0",
        image: teacher2,
        // --- SANDALWOOD THEME (Warm Wood/Amber) ---
...
export function MentorshipSection() {
    return (
        <section className="relative pt-16 pb-20 bg-[#020202] overflow-hidden">

            {/* --- 1. BACKGROUND AMBIENCE (Illustrations) --- */}
            {/* Grid Pattern */}
            ...
            {/* Large Floating Icons (Fills empty space) */}
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
                ...
                {/* --- 2. TRUST STRIP (New Content to fill gap) --- */}
